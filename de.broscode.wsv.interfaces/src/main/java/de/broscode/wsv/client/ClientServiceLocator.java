...
import de.broscode.wsv.services.IMigrationService;
import de.broscode.wsv.services.IUserService;

/**
 * Locates and provides all available application services.
 */
public class ClientServiceLocator implements ApplicationContextAware
{
    /**
    ...
    public final IKundenService getKundenService()
    {
        return (IKundenService)
            getContext().getBean("kundenService");
    }
    
    public final IArztService getArztService()
    {
        return (IArztService)
            getContext().getBean("arztService");
    }
    
    public final IMigrationService getMigrationService()
    {
        return (IMigrationService)
            getContext().getBean("migrationService");
    }
